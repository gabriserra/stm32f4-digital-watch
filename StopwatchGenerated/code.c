...
RT_MODEL_Subsystem_T Subsystem_M;					// rt model structure
PrevZCX_Subsystem_T prevZCSigState;					// zero crossing state
DW_Subsystem_T dwork;								// block states storage
...
TASK(TaskClock)
{
	// invert the tick value
	if (tick == false) tick = true; else tick = false;
...
int main(void)
{
	...
	Subsystem_M.prevZCSigState = &prevZCSigState;
